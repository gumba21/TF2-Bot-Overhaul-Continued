...
public void OnMapStart()
{
	...
	if(StrContains(currentMap, "sd_doomsday" , false) != -1 || StrContains(currentMap, "sd_doomsday_event" , false) != -1)
	{
...
public Action LoadStuff3(Handle timer)
{
	...
	if(StrContains(currentMap, "sd_doomsday" , false) != -1 || StrContains(currentMap, "sd_doomsday_event" , false) != -1)
	{
		...
		int cpred = CreateEntityByName("func_capturezone");
		DispatchKeyValue(cpred, "team", "2");
		int cpblu = CreateEntityByName("func_capturezone");
		DispatchKeyValue(cpblu, "team", "3");

		float origin[3] = {-826.0, 727.0, 410.0};
		float origin2[3] = {-1216.0, 725.0, 410.0};
		float origin3[3] = {-1663.0, 3479.0, 197.0};
		float origin4[3] = {-434.0, 3469.0, 197.0};
		
		float origincp[3] = {-1024.0, 1077.0, 1333.0};
...
public Action MoveTimer(Handle timer)
{
	...
	if(StrContains(currentMap, "sd_doomsday" , false) != -1 || StrContains(currentMap, "sd_doomsday_event" , false) != -1)
	{
		float GoalPos[3] = {-1024.0, 1077.0, 1333.0};
